...
export const metadata: Metadata = {
  ...
  description: "Manage spa products and services, view details, pricing, and handle product operations. Access comprehensive product information including categories, pricing, and featured products.",
