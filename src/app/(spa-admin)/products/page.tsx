...
export const metadata: Metadata = {
  ...
  description: "Manage spa products and services, view details, pricing, and handle product operations. Access comprehensive product information including categories, pricing, and promotions.",
  keywords: "spa products, product management, spa services, pricing, promotions, service categories",
  openGraph: {
    title: "Products Management | SPA Admin Dashboard",
